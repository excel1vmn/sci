...
MULPOW = Pow(Midictl(ctlnumber=[32,33,34,35], init=0, channel=3), 3)
...
a1 = Synth(n1, trigs[0], toggles1, [SIGSNB[0],SIGSNB[8]], transpo, hfdamp, lfofreq, [drums.sig(),input1], mul=MULPOW[0])
a2 = FreakSynth(n1, trigs[1], toggles2, [SIGSNB[1],SIGSNB[9]], transpo, hfdamp, lfofreq, drums.sig(), mul=MULPOW[0])
a3 = Simpler(n1, snds, trigs[2], toggles3, [SIGSNB[2],SIGSNB[10]], transpo, hfdamp, lfofreq,  False, False, drums.sig(), mul=MULPOW[1])
a4 = WaveShape(n1, snds[9], trigs[3], toggles4, [SIGSNB[3],SIGSNB[11]], transpo, hfdamp, lfofreq, drums.sig(), mul=MULPOW[1])

r1 = ReSampler(n1, Mix([a1.sig(),a2.sig(),a3.sig(),a4.sig(),drums.sig()]), trigs[4], toggles5, [SIGSNB[4],SIGSNB[12]], transpo, hfdamp, drums.sig(), mul=MULPOW[2])
r2 = ReSampler(n1, Mix([a1.sig(),a2.sig(),a3.sig(),a4.sig(),r1.sig(),drums.sig()]), trigs[5], toggles6, [SIGSNB[5],SIGSNB[13]], transpo, hfdamp, drums.sig(), mul=MULPOW[2])
r3 = ReSampler(n1, Mix([a1.sig(),a2.sig(),a3.sig(),a4.sig(),r1.sig(),r2.sig(),drums.sig()]), trigs[6], toggles7, [SIGSNB[6],SIGSNB[14]], transpo, hfdamp, drums.sig(), mul=MULPOW[3])
r4 = ReSampler(n1, Mix([a1.sig(),a2.sig(),a3.sig(),a4.sig(),r1.sig(),r2.sig(),r3.sig(),drums.sig()]), trigs[7], toggles8, [SIGSNB[7],SIGSNB[15]], transpo, hfdamp, drums.sig(), mul=MULPOW[3])
